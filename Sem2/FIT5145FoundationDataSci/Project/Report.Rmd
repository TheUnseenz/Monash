...
#   - NA omitted
#   - Factors converted
#   - LinkedIn, Twitter, YouTube filtered out
...
sleep_model <- lm(Sleep_Hours_Per_Night ~ Avg_Daily_Usage_Hours + Academic_Level +
...
mental_health_model <- lm(Mental_Health_Score ~ Avg_Daily_Usage_Hours +# Addicted_Score +
